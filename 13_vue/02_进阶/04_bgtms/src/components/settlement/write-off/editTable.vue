  ...
  <div class="grid" style="">
    ...
    <el-row>
      ...
      <el-col :span="16">
        ...
        <span>费用状态</span>
        <el-select   size="small"  v-model="searchForm.costType" multiple placeholder="请选择" @visible-change="showContent">
          <el-option
    ...
    <el-row style="margin-top: 10px">
      <el-col :span="5">
        <span>销账类型</span>
        <el-select v-model="editForm.xzType" @change="selectXzType" clearable placeholder="请选择" size="small">
          <el-option
            v-for="item in editForm.xzOptions"
            :key="item.value"
            :label="item.value"
            :value="item.value">
          </el-option>
      ...
      <el-col :span="5" v-show="editForm.accountDisplay">
        <span>关联账号</span>
        <el-autocomplete
          size="small"
      ...
      <el-col :span="5">
        ...
        <el-input type="textarea" :rows="1"
                  v-model="editForm.remark" style="width:200px"  size="small"></el-input>
      </el-col>
      <el-col :span="4">
...
/*      "selectRowData.monthlyStatementId" :function (val,oldVal)  {
   ...
   //     this.gridOptions.api.setRowData([]);
        ...
        this.selectPaymentNo(this.selectRowData.receiptPaymentId);
      },
      ...
      selectPaymentNo(item) {
        ...
        this.gridOptions.api.forEachNode( function (node) {
          ...
          if (node.data.relReceiptPaymentId === item) {
      ...
      searchFormBtn() {
        ...
        let params = {
          ...
          costStatus:JSON.stringify(this.searchForm.costType) //传给后台的状态
        };
        console.log(params);
      ...
      addSaveBtn() {
        ...
        let params = {
          ...
          chargeOffType: this.editForm.xzType, //销账类型
      ...
      addInterface(params) {
        ...
        api.xzAddSave(params)
          .then(function(res) {
            ...
            self.showStatus();
            self.editForm.xzType = '';
            self.editForm.realDate = '';
            self.editForm.account = '';
            self.editForm.remark = '';
            self.searchForm.date = '';
            self.searchForm.costType = '';
          })
          .catch(function(err) {
            console.log(err);
          })
      ...
      selectXzType(value){
        if(value === '卡号' || value === '账户') {
          this.editForm.accountDisplay = true;
        }else  {
          this.editForm.accountDisplay = false;
        }
      },
      setChangedValue2(value){
        this.editForm.realDateStr = value;
      },
      //销账类型下拉框显示
      showXzType() {
        let self = this;
        api.selectBusTypeHandle( 'cotype')
          .then(function (res) {
            ...
            self.editForm.xzOptions = selectData
          })
          .catch(function(err){
