  ...
  export default {
    ...
    data() {
      return {
        ...
        rowData: null,
        defCol: [
          {name: '收付日期', isChecked:true, record: "billCodes",filterText: 'text'},
          {name: '收入+', isChecked:true, record: "createDate",filterText: 'text'},
          {name: "支出-", isChecked:true, record: "settleAccountsShortName",filterText: 'text'},
          {name: "余额", isChecked:true, record: "settleAccountsFullName",filterText: 'text'},
          {name: "内转编号", isChecked:true, record: "monthlyStatementNo",filterText: 'text'},
          {name: "备注", isChecked:true, record: "costStatus",filterText: 'text'},
          {name: "结算方简称", isChecked:true,record: "costType",filterText: 'text'},
          {name: "结算方全称", isChecked:true, record: "costName",filterText: 'text'},
          {name: "销账号", isChecked:true, record: "costName",filterText: 'text'},
          {name: "销账 日期", isChecked:true, record: "unitPrice",filterText: 'text'},
        ]
      }
    },
    components: {
