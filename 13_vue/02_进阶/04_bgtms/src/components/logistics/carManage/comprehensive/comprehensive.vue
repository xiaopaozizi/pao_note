    ...
    data() {
      return {
        ...
        defCol: [
          ...
          {name: "主车号",  isChecked:false, record: ""},
          {name: "挂车号",  isChecked:false, record: ""},
          ...
          {name: "主挂重量(KG)",  isChecked:false, record: "shipper"},
          {name: "主挂轴数",  isChecked:false, record: "currency"},
          {name: "备注",  isChecked:false, record: "carnum"},
          {name: "主车年审日期",  isChecked:false, record: "driver"},
          {name: "挂车年审日期",  isChecked:false, record: "driver"}
        ],  //
        /*=======*/
        activeName: '车辆信息'
