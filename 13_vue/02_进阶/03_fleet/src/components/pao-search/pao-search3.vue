        ...
        <div class="row subsearch" v-if="isShowSubSearch">
            ...
            <ul v-if="isShowSubmenuUl">
              <li
                ...
                v-for="subsearch in fields">
                <i
                  class="fa"
                  :class="{ 'fa-check' : subsearch.display }"
                  aria-hidden="true"></i><span>{{subsearch.label}}</span></li>
            </ul>
          </div>
<!--
...
<script>
    ...
    let fields = [
      ...
      {span: 6, type:'daterange',label: '装拆时间',display:true,style:'width:245px',key: 'destinationDateQuery',value: '222',desc: '请输入装拆期限',editable: false,pickerOptions:opiton,change:this.destinationDateQueryChange},
    ...
    export default {
        ...
        methods: {
          ...
          test2(){
            let params = {
              destinationDateQuery: this.DefaultValue.destinationDateQuery
            }
            console.log(params)
...
/*           this.DefaultValue.expdateStr = val;
          ...
          destinationDateQueryChange(val) {
            console.log(val)
            this.DefaultValue.destinationDateQuery = val;
          },
          ...
          /*====================================*/
            ...
            operate(subsearch){
                subsearch.display = !subsearch.display;
                saveArray("paoSearch", this.fields);
            },
            // 搜索
            search(key, event){
                // 监听键盘的值   ↑38   ↓40
