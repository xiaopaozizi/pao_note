...
<script>
  ...
  const waiP = '外排';
  export default {
    props: ['xdOrderId','orderCode','paramData'],
    name: "order-next",
    data() {
      return {
        gridOptions: null,
...
//        return this.gridOptions.api.getSelectedRows();
      ...
      getRowData() {
        ...
        let self = this;
        let params =  {
          relOrderId: this.xdOrderId,
          relXdOrderCode: this.orderCode
        };
    ...
    /*    var newStore = this.rowData.slice();
      ...
      addYdSaveBtn() {
        ...
        let params = {
          relXdOrderCode:this.orderCode,
          relOrderId: this.xdOrderId,
          sendBillInfo: this.paramData.shipperInfo,
          sendBillId: this.paramData.shipperId,
      ...
      editxdOrder(){
       ...
       if(selectRows.length === 1) {
         this.paramData.shipperInfo = this.selectNowData.sendBillInfo;
         this.paramData.shipperId = this.selectNowData.sendBillId;
