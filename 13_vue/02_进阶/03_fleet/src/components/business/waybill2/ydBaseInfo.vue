<template>
   <div class="base-info">
     ...
     <el-row>
       <el-col>
         <el-button @click="tkpaicheBtn"  v-show="tkShowBtn" v-if="isShowInfo">排车</el-button>
         <el-button @click="tkSaveBtn"  v-show="!tkShowBtn">保存</el-button>
         <el-button @click="tkCancelBtn"  v-show="!tkShowBtn">取消</el-button>
         <el-button @click="tkEditMsgBtn"  v-show="isShowInfo" v-if="tkShowBtn">编辑信息</el-button>
         <el-button @click="tkEditSaveBtn"  v-show="!isShowInfo" v-if="tkShowBtn">保存</el-button>
         <el-button @click="cancelTkBtn"  v-show="!isShowInfo" v-if="tkShowBtn">取消</el-button>
       </el-col>
     </el-row>
     ...
     <div v-if="!displayForm">
       <el-form :model="tkForm"  label-width="140px" :rules="tkFormRules"  ref="tkForm">
         <el-row>
           ...
           <el-col :span="8" v-if="tkForm.transFleetShow">
           ...
           <el-col :span="8" v-if="tkForm.plateNoShow">
         ...
         <el-row>
           ...
           <el-col :span="8">
             <el-form-item label="装拆时间">
               <span>{{showForm.destinationDate}}</span>
             </el-form-item>
           </el-col>
           <el-col :span="8">
      ...
      methods: {
        ...
        showInfoMsg() {
          ...
          if (this.activeName === '运单信息') {
            console.log('我是 子集传过来的值');
            for (let objTemp in self.showData) {
              self.showForm[objTemp] = this.showData[objTemp];
              self.tkForm[objTemp] = this.showData[objTemp];
            }
            self.showForm.driverTelphone = this.showData.driverName + '/' + this.showData.driverTelphone;
            self.tkForm.driverTelphone = this.showData.driverName + '/' + this.showData.driverTelphone;
          }
        },
        //点击排车按钮
        tkpaicheBtn() {
          if (this.showData.billStatus === '1-待排车') {
            this.displayForm = false;
            this.tkShowBtn = false;
          }
        ...
        tkSaveBtn() {
          ...
          let tkNp = {
            ...
            transFleet: this.tkForm.fleet, //承运车队
