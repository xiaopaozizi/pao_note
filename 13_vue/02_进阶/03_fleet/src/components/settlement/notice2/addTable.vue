...
<script>
  ...
  export default {
    ...
    components: {
      ...
      'getDataForm.receiptPaymentId':function(val,oldVal) {
    ...
    methods: {
      ...
      getCostList() {
        let self = this;
        let params = {
          relReceiptPaymentId: this.getDataForm.receiptPaymentId ,
        };
      ...
      selectPaymentNo(item) {
        ...
        this.gridOptions.api.forEachNode( function (node) {
          if (node.data.receiptPaymentNo === item) {
      ...
      onGetSetRow(rows) {
        ...
        this.selectPaymentNo(this.getDataForm.receiptPaymentCode);
      },
    },
    beforeMount() {
      this.gridOptions = {
