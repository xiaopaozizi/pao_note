<template>
  <div class="add-write">
    <!--查询框-->
    <el-row>
      <el-form  :inline="true" :model="addSearchFrom" ref="addSearchFrom" label-width="100px">
        <el-row>
          <el-col :span="6">
          ...
          <el-col :span="2">
            <el-button type="primary" @click="addSearchFromSubmit">查询</el-button>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="6">
            <el-form-item label="费用状态">
              <el-select v-model="addSearchFrom.costType" multiple placeholder="请选择" @visible-change="showContent">
                <el-option
