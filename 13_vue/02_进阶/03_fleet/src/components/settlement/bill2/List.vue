...
<!--    &lt;!&ndash;新增弹出框&ndash;&gt;
    <el-dialog :modal="false"  @close="handleClose" :close-on-click-modal="false"  :title="dialogData.title" v-model="dialogFormVisible" :size="dialogData.size">
      ...
      <div slot="footer" style="text-align: center">
        ...
        <el-button type="primary" @click="cancelAddBtn">取消</el-button>
      </div>
    </el-dialog>-->
    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="账单详情" name="账单详情">
        <el-button @click="billEditBtn" v-show="isDetailShow">新增</el-button>
        ...
        <div v-show="!isDetailShow">
          <add-form  ref="refEditForm" :getDataForm="selectNowData" :dialogType="dialogType2" :billShow="billShow"></add-form>
        </div>
      </el-tab-pane>
    </el-tabs>
  </div>
...
/*      //点击账单新增保存
      ...
      billCancelBtn() {
        this.isDetailShow = true;
        this.$refs.refEditForm.cancelHandle();
      },
